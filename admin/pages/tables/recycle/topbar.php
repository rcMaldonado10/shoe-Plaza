    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../forms/general.php"><i class="fa fa-circle-o"></i> Add/Delete Product</a></li>
            <li><a href="../forms/general3.php"><i class="fa fa-circle-o"></i> Update Product</a></li>
            <li><a href="../forms/general4.php"><i class="fa fa-circle-o"></i> Update Customers</a></li>
            <li><a href="../forms/general2.php"><i class="fa fa-circle-o"></i> Add Customer and Admin</a></li>
          </ul>
        </li>
