...
<html>
  <head>
    ...
    <title>AdminLTE | Documentation</title>
...
<section id="introduction">
  ...
  <p class="lead">
    ...
    It is a responsive php template that is based on the CSS framework Bootstrap 3.
...
<section id="components" data-spy="scroll" data-target="#scrollspy-components">
  ...
  <div class="callout callout-danger lead">
    ...
    <p>
      ...
      the component and choose "inspect element" to get to the php quicker than scanning
      the php page.
    </p>
  </div>
  ...
  <div class="box box-solid">
    <div class="box-body" style="position: relative;">
      ...
      <header class="main-header" style="position: relative;">
        <!-- Logo -->
        <a href="index1.php" class="logo" style="position: relative;"><b>Admin</b>LTE</a>
        <!-- Header Navbar: style can be found in header.less -->
  ...
  &LT;a href="../../index1.php" class="logo">
    &LT;!-- LOGO -->
    AdminLTE
  &LT;/a>
        ...
        <nav class="navbar navbar-static-top">
          <div class="container-fluid">
            <div class="navbar-header">
              <a href="../../index1.php" class="navbar-brand"><b>Admin</b>LTE</a>
...
&LT;header class="main-header">
  &LT;nav class="navbar navbar-static-top">
    ...
    &LT;div class="navbar-header">
      &LT;a href="../../index.php" class="navbar-brand">&LT;b>Admin&LT;/b>LTE&LT;/a>
...
<section id="upgrade">
  ...
  <p>There are major changes to the php markup and style to these pages. The best way is to copy the page's code and customize it.</p>
  ...
  <p>Mailbox got an upgrade to include three different views. The views are inbox, read mail, and compose new email. To use these views,
    you should use the provided php files in the pages/mailbox folder.</p>
...
<section id="faq">
  ...
  <p class="lead">AdminLTE is an php template that can be used for any purpose. However, it is not made to be easily installed on Wordpress. It will require some effort and enough knowledge of the Wordpress script to do so.</p>
